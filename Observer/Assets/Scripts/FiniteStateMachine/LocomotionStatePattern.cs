...
{
    public void Crouch(LocomotionContext context)   { context.SetState(new CrouchingState()); }
    public void Jump(LocomotionContext context)     { context.SetState(new InAirState()); }
    public void Fall(LocomotionContext context)     { context.SetState(new InAirState()); }
    public void Land(LocomotionContext context)     { }
}

public class CrouchingState : LocomotionState
{
    public void Crouch(LocomotionContext context)   { context.SetState(new GroundedState()); }
    public void Jump(LocomotionContext context)     { context.SetState(new GroundedState()); }
    public void Fall(LocomotionContext context)     { context.SetState(new InAirState()); }
    public void Land(LocomotionContext context)     { }
}
...
public class InAirState : LocomotionState
{
    ...
    public void Land(LocomotionContext context) { context.SetState(new GroundedState()); }
}